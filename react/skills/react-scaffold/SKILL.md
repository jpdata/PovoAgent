...
1. **Metadata** — project name, pattern (`react`), AI platform, architecture style (Clean Architecture / Vertical Slice Architecture), Generated date, Last Updated, and Stale After (Last Updated + 30 days).
