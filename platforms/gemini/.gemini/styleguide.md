...
Refer to `templates/project-cache.md` for the cache schema. Skills that modify the project should update the cache's refresh log and symbol index incrementally after completion.
