...
This project uses the PovoAgent AI framework. It follows decoupled architecture principles with separation between presentation (UI), business logic, and backend. Refer to `conventions.md` for technology-specific rules and `agent.md` for the development lifecycle.
...
- Dependency injection for all cross-layer communication.
